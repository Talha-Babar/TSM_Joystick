...
private:
  ...
  int8_t _ex;   ///< Delta Ry movement of analog right trigger
  int8_t _ey;   ///< Delta Ry movement of analog right trigger
...
public:
  ...
  bool send(int8_t x, int8_t y, int8_t z, int8_t rz, int8_t rx, int8_t ry,
            int8_t ex, int8_t ey, uint8_t hat, uint32_t buttons);
