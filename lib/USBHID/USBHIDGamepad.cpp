...
void USBHIDGamepad::begin() { hid.begin(); }

void USBHIDGamepad::end() {}

bool USBHIDGamepad::write() {
  hid_gamepad_report_t report = {.x = _x,
                                 .y = _y,
                                 .z = _z,
                                 .rz = _rz,
                                 .rx = _rx,
...
bool USBHIDGamepad::send(int8_t x, int8_t y, int8_t z, int8_t rz, int8_t rx,
                         int8_t ry, int8_t ex, int8_t ey, uint8_t hat,
                         uint32_t buttons) {
  if (hat > 9) {
    return false;
  }
